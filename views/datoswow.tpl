...
<body>
<h1>TWoWtter</h1> 
<h3>A continuación, escribe los datos a continuación referentes a tu personaje de WORLD OF WARCRAFT: </h3>
<p>
...
<br/>
<br/>
<input type="submit" value="Enviar los datos de mi personaje"></form>
</p>
</body>
</html>
